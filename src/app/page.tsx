...
export default function HomePage(){
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 p-4 dark:bg-gray-900">
      <div className="max-w-6xl p-8 sm:p-12 md:p-16 text-center md:text-left">
        <h1 className="text-5xl font-bold leading-tight sm:text-4xl md:text-5xl lg:text-6xl">
        ...
        <p className="mt-6 text-gray-600 sm:text-lg md:text-xl dark:text-gray-300">
        ...
        <div className="mt-8">
          <Link href="/consulta-fipe">
            <Button size="lg" className="w-full sm:w-auto px-8 py-6 text-lg font-semibold bg-blue-800 text-white hover:bg-blue-600">
